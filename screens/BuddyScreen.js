...
export default function BuddyScreen() {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
       ...
       {buddies.map((buddy, i) => (
          <Animated.View key={i} entering={FadeInDown.delay(i*150)} className="p-6 rounded-3xl border mb-4 flex-row justify-between items-center shadow-sm" style={{ backgroundColor: theme.surface, borderColor: theme.border }}>
             ...
             <View className="items-center space-y-2">
                <StyledView className="h-14 w-14 rounded-full items-center justify-center border shadow-sm" style={{ backgroundColor: theme.bg, borderColor: theme.border }}>
